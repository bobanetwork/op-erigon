...
func TestDeriveFields(t *testing.T) {
	...
	if err := receipts.DeriveFields(params.TestChainConfig, hash, number.Uint64(), uint64(0), txs, []libcommon.Address{libcommon.BytesToAddress([]byte{0x0}), libcommon.BytesToAddress([]byte{0x0}), libcommon.BytesToAddress([]byte{0x0})}); err != nil {
