...
func NewEVMBlockContext(header *types.Header, blockHashFunc func(n uint64) libcommon.Hash, engine consensus.EngineReader, author *libcommon.Address, excessDataGas *big.Int, l1CostFunc types.L1CostFunc) evmtypes.BlockContext {
